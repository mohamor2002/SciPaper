...
const SearchPage = () => {
  ...
  const handleSearch=(e)=>{
    e.preventDefault()
    window.location.assign(`/search?title=${search}`)
  }
  ...
  return (
    <AnimatePresence>
      <motion.div className=' font-br-hendrix h-screen w-full bg-gradient-to-tr from-[#F1BBBB] to-[#F1D6BB] flex items-center justify-center'>
        <motion.div exit={{scale:0.5}} transition={{duration:0.5}} initial={{scale:0.5}} animate={{scale:1}} className='relative h-[90%] md:h-[85%] w-[90%] bg-gradient-to-tr from-light-purple via-main-purple to-secondary-purple flex flex-col items-center justify-between'>
